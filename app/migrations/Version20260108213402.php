 ...
 */
final class Version20260108213402 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE vehicules ADD categories_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE vehicules ADD CONSTRAINT FK_78218C2DA21214B7 FOREIGN KEY (categories_id) REFERENCES categories (id)');
        $this->addSql('CREATE INDEX IDX_78218C2DA21214B7 ON vehicules (categories_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_78218C2DA21214B7 ON vehicules');
        $this->addSql('ALTER TABLE vehicules DROP categories_id');
    }
}
